...
function App() {
  ...
  useEffect(() => {
    ...
    try {
      fetch("https://movie-radar-1-qk2b.onrender.com/auth", {
        method: "POST",
        headers: {
    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route
          exact
          path="/myhome"
          element={!loggedIn ? <Login /> : <MyHome />}
        />

        <Route
          exact
          path="/watchlist"
          element={!loggedIn ? <Login /> : <PlayListsPage />}
        />

        <Route
          exact
          path="/movie/:id"
          element={!loggedIn ? <Login /> : <MovieDetails />}
        />
        ...
        <Route
          path="/user-reviews"
          element={!loggedIn ? <Login /> : <UserReviews />}
        />
        ...
        <Route
          path="/friends"
          element={!loggedIn ? <Login /> : <FriendsPage />}
        />

        <Route
          path="/user/:username"
          element={!loggedIn ? <Login /> : <FriendsProfilePage />}
        />
