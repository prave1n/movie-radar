  ...
  return (
    <div>
      ...
      <Box
        ...
        >
          <Typography component="h1" variant="h3" sx={{borderBottom:"3px solid black"}}>
            Your PlayLists  <LocalMoviesRoundedIcon sx={{ m: 1, fontSize: "54px"}}/>
            <Button
                component="label"
                role={undefined}
                variant="contained"
    ...
    <Dialog
      ...
      >
        ...
        <DialogActions>
          ...
          <Button type="submit" onClick={createHandler} >Create PlayList </Button>
        </DialogActions>
      </Dialog>
